...
{
    /// <inheritdoc />
    public partial class UserIdentityOne : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionUser", x => new { x.HistorySessionsId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_SessionUser_AspNetUsers_StudentsId",
                        column: x => x.StudentsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SessionUser_Session_HistorySessionsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionUser_StudentsId",
                table: "SessionUser",
                column: "StudentsId");
        }
